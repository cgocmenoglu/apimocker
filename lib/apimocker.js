...
var isMultipartRequest = function (req) {
...
apiMocker.createServer = function(options) {
	...
	var bodyParserUrlEncodedMiddleware = function () {
	...
	*/
	...
	var bodyParserJsonMiddleware = function () {
		return function (req, res, next) {
			if (isMultipartRequest(req)) {
				return next();
			}
	...
	apiMocker.middlewares.push(bodyParserUrlEncodedMiddleware());
	apiMocker.middlewares.push(bodyParserJsonMiddleware());
